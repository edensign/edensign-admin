...
import { datagridColumns } from "./CityConfig";
import { setCities } from "../../redux/actions/CityAction";
...
const CityListingComponent = () => {
    ...
    const { listData } = useSelector(state => state.allCities);
    const reloadBtn = document.getElementById("reload-btn");
    const { getPaginatedData } = useCommon();
    const { getLocalStorage, setLocalStorage } = Utility();

    useEffect(() => {
        dispatch(setMenuItem("City"));
        setLocalStorage("menu", { selected: "City" });
    }, []);
...
export default CityListingComponent;
