...
import { setInventory } from "../../redux/actions/InventoryAction";
...
const ListingComponent = () => {
    ...
    const { listData } = useSelector(state => state.allInventory);
            ...
            >
                ...
                >
                    <Box display="flex" alignItems="center" gap={1.5}>
                        <InventoryIcon sx={{ color: theme.palette.mode === 'dark' ? '#f1f5f9' : '#1e293b', fontSize: 24 }} />
                        <Typography
                            component="h2"
                            variant="h3"
                    ...
                    >
                        ...
                        <Button
                            type="submit"
                            variant="contained"
                            onClick={() => { navigateTo("/inventory/create") }}
                            sx={{
